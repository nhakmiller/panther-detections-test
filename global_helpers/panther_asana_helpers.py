...
def asana_alert_context(event: dict) -> dict:
    a_c = {
        ...
        "resource_area": "<NO_RESOURCE_TYPE>",
    ...
    if "event_type" in event:
        ...
        # We have not seen category overlap -> only including some event_type
    ...
    r_s_t = deep_get(event, "resource", "resource_subtype", default='NA')
